...
Build the database components for the lineage project 
...
- if a todo list does not already exist
	- study specs/lineage_plan_database.md and build a plan, 
...
- after making changes to the files, validate the changes
	- run all tests in the specs/test_plan_database.md file
