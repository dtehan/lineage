# Requirements Archive: v4.0 Interactive Graph Experience
...
- API-07: Endpoints accept both name and dataset_id formats (added in Phase 20-03)
- API-08: Statistics endpoint returns row count from any index (added in Phase 20-04)
- API-09: DDL endpoint returns table DDL via SHOW TABLE (added in Phase 20-04)

**Note:** API-07, API-08, API-09 were discovered during UAT verification and closed as part of Phase 20. These were implicit requirements that became explicit during implementation.

---
*Requirements defined: 2026-02-01*
*Last updated: 2026-02-06 (Phase 22 complete)*
*Archived: 2026-02-07 as part of v4.0 milestone completion*
